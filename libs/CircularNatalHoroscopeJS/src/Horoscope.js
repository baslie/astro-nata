...
export class Horoscope {
  ...
  createAscendant() {
    const decimalDegrees = applyZodiacOffsetCounter(
      getAscendant({
        ...
        obliquityEcliptic: this.origin.obliquityEcliptic,
      }),
      this._zodiac,
    );
  ...
  createMidheaven() {
    const decimalDegrees = applyZodiacOffsetCounter(
      getMidheavenSun({ localSiderealTime: this.origin.localSiderealTime, obliquityEcliptic: this.origin.obliquityEcliptic }),
      this._zodiac,
    );
